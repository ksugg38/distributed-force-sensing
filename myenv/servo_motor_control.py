...
# USB2DYNAMIXEL.
# To use another Dynamixel model, such as X series, see their details in
# E-Manual(support.robotis.com) and edit below variables yourself.
...
DEVICENAME = "/dev/usbserial-FT62AOBZ".encode('utf-8')
...
dynamixel.write1ByteTxRx(port_num, PROTOCOL_VERSION,
                         DXL_ID, ADDR_PRO_TORQUE_ENABLE, TORQUE_ENABLE)
if dynamixel.getLastTxRxResult(port_num, PROTOCOL_VERSION) != COMM_SUCCESS:
    dynamixel.printTxRxResult(
        PROTOCOL_VERSION, dynamixel.getLastTxRxResult(port_num,
                                                      PROTOCOL_VERSION))
elif dynamixel.getLastRxPacketError(port_num, PROTOCOL_VERSION) != 0:
    dynamixel.printRxPacketError(
        PROTOCOL_VERSION, dynamixel.getLastRxPacketError(port_num,
                                                         PROTOCOL_VERSION))
else:
...
while 1:
    ...
    while 1:
        ...
        if dynamixel.getLastTxRxResult(
            ...
            dynamixel.printRxPacketError(PROTOCOL_VERSION,
...
dynamixel.write1ByteTxRx(port_num, PROTOCOL_VERSION,
                         DXL_ID, ADDR_PRO_TORQUE_ENABLE, TORQUE_DISABLE)
if dynamixel.getLastTxRxResult(port_num, PROTOCOL_VERSION) != COMM_SUCCESS:
    dynamixel.printTxRxResult(
        PROTOCOL_VERSION, dynamixel.getLastTxRxResult(port_num,
                                                      PROTOCOL_VERSION))
